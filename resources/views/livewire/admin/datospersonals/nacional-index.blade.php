      ...
      <div class="row g-2 align-items-center">
        <div class="col">
          ...
          <div class="page-pretitle">
              Lista de Sinpatizantes / Militantes NACIONAL
          </div>
          <h2 class="page-title">
              Dashboard
          </h2>
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Lista Nacional</h3>
            </div>
                  ...
                  <div class="ms-auto text-muted">
                      Search:
                        ...
                        <input wire:model.live="searchdepartamento" type="text" class="form-control form-control-sm"
                            aria-label="searchdepartamento invoice" placeholder="Departamento">
                        </div>
                        <div class="ms-2 d-inline-block">
                        <input wire:model.live="searchprovincia" type="text" class="form-control form-control-sm"
                            aria-label="searchprovincia invoice" placeholder="Provincia">
                        </div>
                        <div class="ms-2 d-inline-block">
                  ...
                  @foreach ($datopersonals as $datospersonal)
                      <tr>
                        ...
                        <td>
                          ...
                          @if (in_array($datospersonal->ejecutora?->nivel,['Desarrollador']))
                          
                          @else
                            {{-- //no modifica si es de si mismo --}}
                            @if (auth()->user()->id == $datospersonal->user->id)
