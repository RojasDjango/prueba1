              ...
              <div class="row g-2 align-items-center">
                <div class="col">
                  ...
                  <div class="page-pretitle">
                      Lista de Simpatizantes y Militantes - Distrital
                  </div>
                  <h2 class="page-title">
                      Dashboard
                  </h2>
                          ...
                          <div class="ms-auto text-muted">
                              Search:
                                ...
                                <input wire:model.live="searchdistrito" type="text" class="form-control form-control-sm"
                                    aria-label="searchdistrito invoice" placeholder="Distrito" readonly>
                                </div>
                                <div class="ms-2 d-inline-block">
                          ...
                          @foreach ($datopersonals as $datospersonal)
                              <tr>
                                ...
                                <td>
                                  ...
                                  @if (in_array($datospersonal->ejecutora?->nivel,['Desarrollador','Nacional','Regional','Provincial']))
