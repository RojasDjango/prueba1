<div class="container container-tight py-4">
    ...
    <div class="card card-md">
        <div class="card-body">
            <h2 class="h2 text-center mb-4">ACTUALIZACIÓN DE COMANDO</h2>
            ...
            <form  wire:submit.prevent="update" >
                ...
                <div class="mb-3">
                    <label for="name" class="form-label">Nombre del comando</label>
                    <input style="text-transform:uppercase" type="text" class="form-control" wire:model="nameejecutora"
                    id="name" name="name" placeholder="Nombre del Comando" >
                    @error('name')
                ...
                <div class="form-selectgroup-boxes row mb-3">
                    ...
                    <div class="col-lg-6">
                        <label class="form-selectgroup-item">
                            <input wire:model="nivel_coordinador" type="radio" name="nivel_coordinador" value="CEN" class="form-selectgroup-input" checked>
                    ...
                    <div class="col-lg-6">
                        <label class="form-selectgroup-item">
                            <input wire:model="nivel_coordinador" type="radio" name="nivel_coordinador" value="Regional" class="form-selectgroup-input" checked>
                            <span class="form-selectgroup-label d-flex align-items-center p-3">
                                <span class="me-3">
                                    <span class="form-selectgroup-check"></span>
                                </span>
                    ...
                    <div class="col-lg-6">
                        <label class="form-selectgroup-item">
                            <input wire:model="nivel_coordinador" type="radio" name="nivel_coordinador" value="Distrital" class="form-selectgroup-input" checked>
                            <span class="form-selectgroup-label d-flex align-items-center p-3">
                                <span class="me-3">
                                    <span class="form-selectgroup-check"></span>
                                </span>
                    ...
                    <div class="col-lg-6">
                        <label class="form-selectgroup-item">
                            <input wire:model="nivel_coordinador" type="radio"  name="nivel_coordinador" 
                            value="Comando" class="form-selectgroup-input" checked>
                            <span class="form-selectgroup-label d-flex align-items-center p-3">
                                <span class="me-3">
                                    <span class="form-selectgroup-check"></span>
                                </span>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="mb-3">
                            ...
                            wire:click="buscarResponsableejecre">Buscar Responsable</button>
                        </div>
                    </div>
