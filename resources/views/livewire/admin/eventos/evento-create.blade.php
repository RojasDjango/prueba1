<div class="container container-tight py-4">
    ...
    <div class="card card-md">
        <div class="card-body">
            <h2 class="h2 text-center mb-4">Crear Nuevo Evento</h2>
            ...
            <form wire:submit.prevent="save" method="post" autocomplete="off">
                ...
                <div class="mb-3">
                    ...
                    <select wire:model.live="SelectDepartamentoEvento" name="SelectDepartamentoEvento" id="departamento" class="form-control @error('SelectDepartamentoEvento') is-invalid @enderror">
