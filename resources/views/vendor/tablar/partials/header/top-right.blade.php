@auth
    <div class="nav-item dropdown">
        <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown"
           aria-label="Open user menu">
            ...
            <div class="d-none d-xl-block ps-2">
                ...
                <div class="mt-1 small text-muted">Militante Batallaperú</div>
            </div>
        </a>
        <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
            ...
            <a href="{{ route('admin.dato') }}" class="dropdown-item">Perfil</a>
            <a href="https://forms.office.com/r/FphSfD04pS" class="dropdown-item">Tú Opinión</a>
            <div class="dropdown-divider"></div>
            {{-- <a href="#" class="dropdown-item">Mejoras</a> --}}
