...
namespace App\Livewire\Admin\Datospersonals\Departamentos;
...
class DepaIndex extends Component
{
    use WithPagination;
    ...
    public function render()
    {
        ...
        $query = Datospersonal::query()//inicia una nueva consulta eloquent para el modelo Datospersonales
            ...
            if ($userData && $userData->departamento_id) {
                $departamento = Departamento::find($userData->departamento_id);
                if ($departamento) {
                    $this->searchdepartamento = $departamento->name;
                }
            }
            //fin ***************************
        ...
        return view('livewire.admin.datospersonals.departamentos.depa-index',compact('datopersonals'));
    }
}
